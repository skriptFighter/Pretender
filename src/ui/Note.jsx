...
function Note({
 ...
 return (
  <div
   ...
   className={`flex flex-col justify-between overflow-hidden rounded-md shadow-md shadow-gray-400 transition-shadow duration-300 dark:shadow-slate-600 ${isGrid ? "phoneSm:h-96 phoneSm:w-64 phoneLg:h-96 phoneLg:w-96 h-64 w-48 self-start " : "w-1/3"} `}
   style={{
