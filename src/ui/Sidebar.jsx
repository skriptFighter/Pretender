  ...
  <div className="fixed top-10 flex h-full min-w-64 flex-col justify-between pb-10">
   <div className="  flex  flex-col gap-4">
    <div className="flex flex-col">
     ...
     <div
      className="cursor-pointer rounded-r-md bg-tertiary px-4 py-2 text-center font-semibold dark:bg-tertiaryDark"
   ...
   <div>
    <Item
     icon={<MdOutlineDarkMode fontSize={28} /> || <MdOutlineWbSunny />}
     label={"Dark"}
    />
...
function Item({ icon, label, to, className }) {
 return (
  <Link
   to={to}
